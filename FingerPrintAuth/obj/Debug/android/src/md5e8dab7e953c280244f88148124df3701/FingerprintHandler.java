...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("FingerPrintAuth.FingerprintHandler, FingerPrintAuth, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", FingerprintHandler.class, __md_methods);
	}
	...
	public FingerprintHandler ()
	{
		...
		if (getClass () == FingerprintHandler.class)
			mono.android.TypeManager.Activate ("FingerPrintAuth.FingerprintHandler, FingerPrintAuth, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
	...
	public FingerprintHandler (android.content.Context p0)
	{
		super ();
		if (getClass () == FingerprintHandler.class)
			mono.android.TypeManager.Activate ("FingerPrintAuth.FingerprintHandler, FingerPrintAuth, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "Android.Content.Context, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", this, new java.lang.Object[] { p0 });
	}
